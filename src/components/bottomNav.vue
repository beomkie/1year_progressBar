      ...
      <b-navbar fixed="bottom" type="dark" variant="black" style="height: 70px;">
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav class="custom-navbar-nav" style="padding-left:20px;">
            ...
            <b-nav-item @click="selectedNavItem = 'social'" to="/socialView" :style="{ fontWeight: selectedNavItem === 'social' ? 'bold' : 'normal', color: selectedNavItem === 'social' ? 'white' : 'inherit' }">Social</b-nav-item>
...
export default {
  ...
  computed: {
    navStyle() {
      return {
        // Add your custom styles for the navigation here
        // Example: backgroundColor: '#333'
      };
    }
  }
};
